...
print("rfind", costr.rfind("file.txt", "file", false, 1))
print("rfind", costr.rfind("file.txt", "file", false, -3))
print("rfind", costr.rfind("file.txt", "file", false, -80))
print("rfind", costr.rfind("", "file", false, 20))
print("rfind", costr.rfind("file.txt", "file", false, 3))

print("rfind", costr.rfind("file.txt", ".x", true))
print("rfind", costr.rfind("dir/file.txt", "\\/", true))
print("rfind", costr.rfind("dir\\file.txt", "\\/", true))